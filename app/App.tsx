...
function Gate() {
  ...
  // Phase Y — createFamily is E2EE by default and self-grants its own anchor
  // key server-side; there's no key to show/save here anymore (see
  // FamilyGateScreen's header comment), so a created/joined family swaps
